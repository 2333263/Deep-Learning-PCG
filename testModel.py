...
def main():
    ...
    for valid in range(2):
        if(valid==1):
            forceValid=True
        for iterations in [1,2,3,4,5,10,100,1000,10000]:
            fitness=[]
            ...
            ax[0].imshow(1-startLevel,cmap="gray")
            ...
            ax[1].imshow(1-output.reshape(30,45),cmap="gray")
        ...
        # plt.show()
            plt.savefig("Level Graphs/"+modelName+"/"+str(iterations)+"_Iterations_"+str(forceValid)+"_Valid")
            ...
            plt.ylabel("Fitness")
            plt.savefig("Level Graphs/"+modelName+"/Fitness_"+str(iterations)+"_Iterations"+str(forceValid)+"_Valid")
            plt.close()
