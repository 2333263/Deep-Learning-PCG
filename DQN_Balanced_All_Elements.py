...
def trainModel(trainingData,trainingTargets,testingData,testingTargets):
   ...
   # print(history)
    ...
    with open("NPYs/DQN_Balanced_All_Elements/Info.json","w") as f:
        json.dump(information,f)
        f.close()
    np.save("NPYs/DQN_Balanced_All_Elements/Loss.npy",history.history['loss'])
    np.save("NPYs/DQN_Balanced_All_Elements/ValLoss.npy",history.history['val_loss'])
    plt.plot(history.history['loss'],label="Training Loss")
    plt.plot(history.history['val_loss'],label="Validation Loss")
    plt.legend()
    plt.savefig("Graphs/DQN_Balanced_All_Elements/Loss.png")
    model.save("Models/DQN_Balanced_All_Elements",save_format="tf")
