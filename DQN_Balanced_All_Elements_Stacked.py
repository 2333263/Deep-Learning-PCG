...
def trainModel(trainingData,trainingTargets,testingData,testingTargets):
   ...
   # print(history)
    ...
    with open("NPYs/DQN_Balanced_All_Elements_Stacked/Info.json","w") as f:
        json.dump(information,f)
        f.close()
    np.save("NPYs/DQN_Balanced_All_Elements_Stacked/Loss.npy",history.history['loss'])
    np.save("NPYs/DQN_Balanced_All_Elements_Stacked/ValLoss.npy",history.history['val_loss'])
    plt.plot(history.history['loss'],label="Training Loss")
    plt.plot(history.history['val_loss'],label="Validation Loss")
    plt.legend()
    plt.savefig("Graphs/DQN_Balanced_All_Elements_Stacked/Loss.png")
    model.save("Models/DQN_Balanced_All_Elements_Stacked",save_format="tf")
